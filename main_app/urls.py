...
path("", views.login_page, name='login_page'),
    ...
    path("program/manage/", hod_views.manage_program, name='manage_program'),
    ...
    path('add_branch', hod_views.add_branch, name='add_branch'),
    path('manage_branch', hod_views.manage_branch, name='manage_branch'),
    path('edit_branch/<int:branch_id>', hod_views.edit_branch, name='edit_branch'),
    path('delete_branch/<int:branch_id>', hod_views.delete_branch, name='delete_branch'),
    ...
    # Subject Allocation
    path('subject_allocation/add', hod_views.add_subject_allocation, name='add_subject_allocation'),
    path('subject_allocation/manage', hod_views.manage_subject_allocation, name='manage_subject_allocation'),
    path('subject_allocation/edit/<int:allocation_id>', hod_views.edit_subject_allocation, name='edit_subject_allocation'),
    path('subject_allocation/delete/<int:allocation_id>', hod_views.delete_subject_allocation, name='delete_subject_allocation'),
